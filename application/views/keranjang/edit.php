        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Form Edit Data Keranjang</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="<?= base_url('keranjang/update') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="id_user" id="" class="form-control" data-live-search="true" required>
                                                ...
                                                <?php foreach ($user as $data) : ?>
                                                    <option value="<?= $data->id_user ?>" <?= $data->id_user == $keranjang->id_user ? 'selected' : '' ?>>
                                                        <?= $data->nama_user ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_menu" id="" class="form-control" data-live-search="true" required>
                                                ...
                                                <?php foreach ($menu as $data) : ?>
                                                    <option value="<?= $data->id_menu ?>" <?= $data->id_menu == $keranjang->id_menu ? 'selected' : '' ?>>
                                                        <?= $data->nama_menu ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label>Jumlah</label>
                                            <input type="number" name="jml" class="form-control" placeholder="Masukkan Jumlah" value="<?= $keranjang->jml ?>" required>
                                        </div>
                                    </div>
                                </div>
